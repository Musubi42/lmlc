<template>
  ...
  <div class="flex-grow flex flex-col justify-end 2xl:mb-20 lg:order-2 order-1">
  ...
  <div class="flex 2xl:w-2/5 lg:w-1/4 relative 2xl:mt-8 lg:mt-8 mr-10 lg:order-1 order-2">
