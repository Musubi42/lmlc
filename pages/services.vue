<template>
  <div>
    ...
    <p>Je suis</p>
    <p>
      Le passage de Lorem Ipsum standard, utilisé depuis 1500 "Lorem ipsum dolor sit amet,
    ...
    <p>
      Section 1.10.32 du "De Finibus Bonorum et Malorum" de Ciceron (45 av. J.-C.) "Sed ut
    ...
    <p>
      Traduction de H. Rackham (1914) "But I must explain to you how all this mistaken
    ...
    <p>
      Section 1.10.33 du "De Finibus Bonorum et Malorum" de Ciceron (45 av. J.-C.) "At
    ...
    <br />
    <p>
      Traduction de H. Rackham (1914) "On the other hand, we denounce with righteous
