      ...
      <div class="relative container px-4 mx-auto">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-24">
            <span
              class="inline-block py-1 px-3 mb-4 text-xs font-semibold text-orange-900 bg-orange-50 rounded-full"
            ...
            <div class="w-full lg:w-1/2 px-4 mb-6 lg:mb-0">
              <div class="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
                <button class="flex group w-full items-start justify-between text-left">
                  <div class="max-w-xl pr-5">
                    <h3 class="text-xl font-semibold text-orange-900 mb-3">
                  ...
                  <div>
                    <span
                      class="flex h-9 w-9 items-center justify-center rounded-full bg-orange-900 text-orange-50"
                    >
                      <svg
                        width="17"
                        height="3"
              ...
              <div class="px-8 py-10 mb-6 bg-white rounded-3xl shadow-lg">
                <button class="flex group w-full items-start justify-between text-left">
                  <div class="max-w-xl pr-5">
                    <h3
                      class="text-xl font-semibold text-black group-hover:text-orange-900"
                    >
                  ...
                  <div>
                    <span
                      class="flex h-9 w-9 items-center justify-center rounded-full bg-orange-50 text-orange-900 group-hover:bg-orange-900 group-hover:text-orange-50 transition duration-200"
                    >
                ...
                <button class="flex group w-full items-start justify-between text-left">
                  <div class="max-w-xl pr-5">
                    <h3
                      class="text-xl font-semibold text-black group-hover:text-orange-900"
                    >
                      How to apply saturn to our project?
                    </h3>
                    <p class="hidden group-hover:block mt-3 text-lg text-gray-500">
                      Pretium ac auctor quis urna orci feugiat. Vulputate tellus velit
                      tellus orci auctor vel nulla facilisi ut. Ante nunc risus viverra
